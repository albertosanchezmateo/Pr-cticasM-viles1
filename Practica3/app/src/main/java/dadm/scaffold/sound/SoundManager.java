...
public final class SoundManager {
	...
	private AssetFileDescriptor afdMenu, afdJuego;
	...
	public void playMenuMusic(){
		try {
			bgPlayer.stop();
			bgPlayer = new MediaPlayer();
			bgPlayer.setDataSource(afdMenu.getFileDescriptor(),
					afdMenu.getStartOffset(), afdMenu.getLength());
	...
	public void playGameMusic(){
		try {
			bgPlayer.stop();
			bgPlayer = new MediaPlayer();
			bgPlayer.setDataSource(afdJuego.getFileDescriptor(),
					afdJuego.getStartOffset(), afdJuego.getLength());
			bgPlayer.setLooping(true);
			bgPlayer.setVolume(DEFAULT_MUSIC_VOLUME, DEFAULT_MUSIC_VOLUME);
			bgPlayer.prepare();
			bgPlayer.start();
